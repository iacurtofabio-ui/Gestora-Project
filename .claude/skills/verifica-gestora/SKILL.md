...
description: Usa prima di dichiarare concluso un task di codice sul progetto Gestora (backend o frontend) — richiede evidenza (build/test) prima di affermare che qualcosa funziona o è corretto.
---

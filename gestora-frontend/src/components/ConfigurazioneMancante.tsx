    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-gray-50">
      <div className="bg-white border rounded-lg p-6 max-w-lg w-full">
        ...
        <p className="text-sm text-gray-600 mb-4">
          ...
          <code className="bg-gray-100 px-1 rounded">VITE_API_URL</code> non e' impostata. Finche'
          manca, nessuna funzione puo' funzionare.
        </p>
        ...
        <ul className="text-sm text-gray-600 list-disc pl-5 space-y-1">
          ...
          <li>
            in produzione, impostarla fra le variabili di progetto dell'hosting e ricostruire il
